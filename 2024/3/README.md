...
`x`__mul(2,4)__`%&mul[3,7]!@^do_not_`__mul(5,5)__`+mul(32,64]then(`__mul(11,8)mul(8,5)__`)`
...
Only the __most recent__ do() or don't() instruction applies. At the beginning of the program, mul instructions are enabled.
